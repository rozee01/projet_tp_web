<!--head start-->
<?php $pageTitle="North America"; $style2="styles.css" ;$style1="https://cdn.jsdelivr.net/npm/bootstrap@5.2.3/dist/css/bootstrap.min.css" ; include_once ('../dependancies.php') ; ?>
        ...
        <div class="row">
            ...
            <div class="col-lg-4 col-md-6">
                <div class="destination-box">
                    ...
                    <h3>Mexico</h3>
                    <p>LMexico is a vibrant destination that offers a rich tapestry of culture, history, and natural beauty.
